...
void setup(){
    // Hora de reinicio
     ...
     tiempoBase = tiempoMs;
  	...
  	// Configuración columnas y filas de LCD
     lcd.begin(16,2);
    
  	// Configuración buzzer, led y botón alarma
     ...
     attachInterrupt(0, Interruptor, RISING);
  	...
  	// Configuración del puente H y del interruptor
...
void loop(){
    // Envío señales iniciales al puente H: motor detenido
     ...
     do{
       Despliegue();
       delay(tiempoRet);
       tiempoActual = millis()*10 + tiempoBase;
